...
# badWordsURL <- "https://www.freewebheaders.com/full-list-of-bad-words-banned-by-google/base-list-of-bad-words_text-file_2021_01_18.zip"
badWordsFile <- "data/base-list-of-bad-words_text-file_2021_01_18.txt"
if (!file.exists('data')) {
    dir.create('data')
}
...
library(tm)
# download bad words file
badWordsFile <- "Data-Science-Coursera-Capstone/profanity.txt"
if (!file.exists('data')) {
    dir.create('data')
}
